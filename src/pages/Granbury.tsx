...
export function Granbury() {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://dallasfortworthzultys.com/granbury-tx-zultys-phone-systems');
    ...
    const schema = {
      ...
      url: 'https://dallasfortworthzultys.com/granbury-tx-zultys-phone-systems',
