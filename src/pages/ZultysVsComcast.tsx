      ...
      <main className="flex-1">
        ...
        <section className="relative pt-24 pb-32 overflow-hidden bg-slate-950">
          <div className="absolute inset-0 opacity-20">
            <img src={HERO_BACKGROUND} alt="Zultys vs Comcast comparison - Best business VoIP phone systems for DFW enterprise companies" className="w-full h-full object-cover" />
          </div>
