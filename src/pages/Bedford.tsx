  ...
  const benefits = [
    {
      ...
      description: 'Tailored Zultys systems for Bedford\'s mix of professional services, retail centers, and growing commercial sectors in Tarrant County.',
      icon: MapPin,
    },
    {
      title: 'HEB Area Focus',
      description: 'Rapid on-site support for businesses located in the heart of the Hurst-Euless-Bedford growth corridor.',
      icon: Zap,
    },
    {
