...
export function Kaufman() {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://dallasfortworthzultys.com/kaufman-tx-zultys-phone-systems');
    ...
    const schema = {
      ...
      url: 'https://dallasfortworthzultys.com/kaufman-tx-zultys-phone-systems',
