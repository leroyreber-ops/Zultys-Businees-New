      ...
      <main className="flex-1">
        ...
        <section className="relative pt-24 pb-32 overflow-hidden bg-slate-900">
          <div className="absolute inset-0 opacity-20">
            <img src={HERO_BACKGROUND} alt="Authorized Zultys Partner - FAQ Page showing Hero Background with Zultys unified communications" className="w-full h-full object-cover" />
          </div>
