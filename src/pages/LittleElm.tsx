...
export function LittleElm() {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://dallasfortworthzultys.com/little-elm-tx-zultys-phone-systems');
    ...
    const schema = {
      ...
      url: 'https://dallasfortworthzultys.com/little-elm-tx-zultys-phone-systems',
