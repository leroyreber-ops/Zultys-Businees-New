...
export function Lancaster() {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://dallasfortworthzultys.com/lancaster-tx-zultys-phone-systems');
    ...
    const schema = {
      ...
      url: 'https://dallasfortworthzultys.com/lancaster-tx-zultys-phone-systems',
